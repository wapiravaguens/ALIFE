...
public class PredatorGenotype {
    ...
    public static Object[] randomValues() {
        ...
        code[7] = ((rand.nextFloat() * 1.25f) + 3.0f) * 60.0f; //eRepro,
        ...
        code[14] = (float) ((rand.nextGaussian() * 0.1) + 2.0f); //fCoh
        code[15] = (float) ((rand.nextGaussian() * 0.01) + 0.15f); //maxforce
        code[16] = (float) ((rand.nextGaussian() * 0.1) + 4.0f); //maxspeed
        return code;
    }
